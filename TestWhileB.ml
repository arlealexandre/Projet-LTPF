...
let _ = assert(p_Programme (list_of_string ";;;;") = [])
let _ = assert(p_Programme (list_of_string "a:=1;b:=1;c:=1") = [])
...
let _ = assert(p_Programme (list_of_string " ; ;
                                            ; ; ") = [])
let _ = assert(p_Programme (list_of_string "a :=1;
...
let _ = assert(p_Programme (list_of_string "w ( a ) {
};

w(a){}") = [])
let _ = assert(p_Programme (list_of_string " w (a   ) {};  w

(a)
{    }") = [])
let _ = assert(p_Programme (list_of_string " w (a) {a := 1
...
let _ = assert(p_Programme (list_of_string "w ( a ) { w ( b ) { } }") = [])

let _ = p_Programme (list_of_string "b:=0;a := ( a + b ) . a + ! b ;")
...
let _ = pr_Affectation (list_of_string "a := 0")
let _ = pr_Programme (list_of_string "a:=1;b:=0;c:=(a+b).a+!b;
